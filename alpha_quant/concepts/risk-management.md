...
Per-position: every entry gets a stop-loss at 2× ATR below the entry price. As the trade moves in favor, trailing stops lock in profits. At +1× ATR profit, the trailing stop activates. At +2× ATR profit, a partial take-profit closes half the position. Trades held over 30 days are closed by time stop.
